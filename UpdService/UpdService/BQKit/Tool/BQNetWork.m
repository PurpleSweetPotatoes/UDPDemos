...
+ (NSURLSessionDataTask *)postUrl:(NSString *)urlString
                       ...
                       compeleted:(void (^)(id _Nullable))handle {
...
+ (void)loadData:(NSData * _Nullable)data
        response:(NSURLResponse * _Nullable)response
           error:(NSError * _Nullable)error
          handle:(void(^)(id _Nullable))handle {
...
+ (NSMutableURLRequest *)configPostImageURLWithString:(NSString *)string
...
//get请求url编码拼接
+ (NSURL *)addUrlString:(NSString *)urlString
